...
`;
  ...
  app.post("http://64.225.56.183/login", async (req, res) => {
  ...
  app.get("http://64.225.56.183/admin", isAdmin, async (req, res) => {
    const { username } = req.body;
  ...
  app.post("http://64.225.56.183/clock-in", async (req, res) => {
    const { username } = req.body;
  ...
  app.post("http://64.225.56.183/clock-out", async (req, res) => {
    const { username } = req.body;
  ...
  app.get("http://64.225.56.183/api/admin/users", async (req, res) => {
    try {
